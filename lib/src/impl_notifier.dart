...
class NotifierImpl implements Notifier {
  ...
  void notify<T>(String action, T data) {
    _lock.synchronized(() {
      ...
      _actionDataMappings[action] = NotifierData(hasData: data != null, data: data);
...
class _NotifierWidgetState extends State<_NotifierWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: widget.notifier._actionStreamMappings[widget.action].stream.asBroadcastStream(),
      builder: (context, _) {
